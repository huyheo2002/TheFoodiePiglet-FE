...
import bg from "../../assets/images/Base/bg-slider.jpg";
        ...
        <div className="container mx-auto p-4 text-white">
            ...
            >
                <div className="absolute inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex flex-col justify-center items-center">
                    ...
                    <p className="text-3xl">Khám phá hương vị độc đáo đến từ châu Á</p>
                    <div className="mt-3">
            ...
            <div className="my-6">
                ...
                <div className="h-[500px] w-full relative overflow-hidden my-8">
                    ...
                    >
                        <div className="text-[#654f42] font-semibold text-2xl text-left">Thông tin nhà hàng</div>
                        <ul>
                            <li className="text-[#78604b] font-medium text-base">Địa chỉ: Ba đình, Hà nội</li>
                            <li className="text-[#78604b] font-medium text-base">Số điện thoại: 1506 2002</li>
                            <li className="text-[#78604b] font-medium text-base">Email liên hệ: huy12@support.com</li>
                        </ul>
                        <div className="bg-[#654f42] w-full h-[2px] my-2"></div>

                        <div className="text-[#654f42] font-semibold text-2xl text-left">Đặc điểm nổi bật</div>
                        <ul>
                            <li className="text-[#78604b] font-medium text-base">Chuyên về các món ăn độc đáo từ thịt lợn.</li>
                            <li className="text-[#78604b] font-medium text-base">Đội ngũ đầu bếp tài năng và đam mê.</li>
                            <li className="text-[#78604b] font-medium text-base">Chất lượng thực phẩm và dịch vụ là ưu tiên hàng đầu.</li>
                        </ul>
                    </div>
                ...
                <div className="h-[500px] w-full relative overflow-hidden my-8">
                    ...
                    >
                        <div className="text-[#654f42] font-semibold text-2xl text-left">Đội ngũ Đầu Bếp của The Foodie Piglet</div>
                        <ul>
                            <li className="text-[#78604b] font-medium text-base">Tại The Foodie Piglet, chúng tôi tự hào có một đội ngũ đầu bếp tài năng và đam mê.</li>

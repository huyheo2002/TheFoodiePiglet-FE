...
function Menu({ data, userLogin }) {
  ...
  const { reloadCart } = useContext(GlobalContext);
        ...
        data.map((item, index) => {
          return (
            ...
            >
                      ...
                      {!item.onlyShowIcon ? (
                        <Fragment>
                          {t(`userLogin.msgWelcome`) +
                            `, ${
                              userLogin.user.name || userLogin.user.username
                            }`}
                          {item.icon && (
                      ...
                      {!item.onlyShowIcon ? (
                        ...
                        <Fragment>
                          {item.icon && (
                            <Fragment>
                              <span
                                className={clsx("text-current p-2", {
              ...
              {/* submenu */}
              {item.subNav && userLogin && item.keyword === "login" && (
                <SubMenu
                  data={item.subNav}
                  className="group-hover:flex"
                  dataUserLogin={userLogin ?? null}
                />
              )}

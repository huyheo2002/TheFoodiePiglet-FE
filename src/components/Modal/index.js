...
function Modal({ children, onClick, open, close, className, custom }) {
    ...
    if (custom) {
        return <div className="fixed inset-0 z-[9999999999999999] bg-rgba-black-0.50 flex justify-center items-center select-none" onClick={close}>
    ...
    return (
        <div className="fixed inset-0 z-[9999999999999999] bg-rgba-black-0.50 flex justify-center items-center select-none" onClick={close}>

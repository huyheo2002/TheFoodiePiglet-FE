...
function Header() {
  ...
  return (
    <div
      className={clsx(
        "bg-white h-16 mx-3 mt-2 px-4 py-2 fixed z-50 w-[calc(100%-300px-1.5rem)] flex justify-between items-center rounded-lg shadow-black-rb-0.35",
        {
    ...
    >
      <div className="flex items-center">
        <span
          className="group px-2 py-2 inline-block relative rounded-full hover:bg-[#e6f2fe] transition-all duration-300 cursor-pointer"

              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    View and manage incoming orders. Keep track of customer
                    details, order status, and more.
                  </p>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    Update and modify the restaurant menu. Add new items, edit
                    prices, and categorize dishes.
                  </p>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    Gain insights into restaurant performance. Analyze sales,
                    customer trends, and popular dishes.
                  </p>
            ...
            <div className={clsx("w-[75vw-1rem]")}>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    Manage restaurant staff accounts. Assign roles, reset
                    passwords, and monitor account activity.
                  </p>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    View high-level statistics for the restaurant. Track overall

        ...
        if (responseAddToCartSubmit) {
          ...
          if (dataProduct) {
            ...
            if (checkVariant.length > 0) {
              let filterValue = checkVariant.filter(
                (item) => item.name === size
              );
              if (filterValue.length > 0) {
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          <div className="grid grid-cols-2 gap-6">
            <div className="col-span-1 flex flex-col justify-center">
              <Image
                src={dataProduct && dataProduct.image}
                alt="Product Image"
                className="rounded-lg shadow-md m-7"
              />
            </div>
            <div className="col-span-1 flex flex-col justify-center">
              <h1 className="text-2xl font-semibold mb-2">
                {dataProduct ? dataProduct.name : "Product Name"}
              </h1>
              ...
              <div className="flex items-center my-4 select-none">
                <h2 className="capitalize block text-base font-medium text-black tracking-wider mt-3 mb-2 mr-4">
                  Count:{" "}
                </h2>
              ...
              <div className="flex items-center gap-4 my-3">
                ...
                <div className="flex items-center gap-2">
                  <span className="flex justify-start items-center">
                    <p className="text-lg line-through opacity-50 text-gray-500">
              ...
              <form
                onSubmit={onhandleSubmitAddToCart}
                autoComplete="off"
